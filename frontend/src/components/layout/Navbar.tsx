        ...
        <nav className="sticky top-0 z-50 w-full border-b border-border bg-card shadow-theme-sm">
            <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4 sm:gap-6 text-sm font-semibold text-secondary">
                    ...
                    />
                    <ThemeToggle />
                    <Link to="/companies" className="hover:text-accent transition-colors hidden sm:block">Companies</Link>
                    <Link to="/hubs" className="hover:text-accent transition-colors hidden sm:block">Domains</Link>
