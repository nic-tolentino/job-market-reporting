  ...
  return (
    <div className="p-6 space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-sm text-muted mt-0.5">Pipeline overview and system health</p>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {health ? (
          ...
          <div className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-full bg-elevated text-muted">
      ...
      <div className="grid md:grid-cols-2 gap-4">
        <div className="border border-border rounded-lg p-4 bg-card">
          <h2 className="text-sm font-medium text-secondary mb-3">Recent activity</h2>
          <p className="text-xs text-muted">
            Activity feed will populate once crawl runs and ingestions are recorded in BigQuery.
          </p>
        </div>
        <div className="border border-border rounded-lg p-4 bg-card">
          <h2 className="text-sm font-medium text-secondary mb-3">Alerts</h2>
          <p className="text-xs text-muted">
