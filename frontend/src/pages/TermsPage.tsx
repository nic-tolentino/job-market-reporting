    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10 py-8 md:py-12">
            ...
            <Card className="p-0 overflow-hidden">
                <div className="p-6 md:p-8 prose prose-slate dark:prose-invert max-w-none text-secondary space-y-6">
                    <div>
                        <H2 className="mb-2">1. Description of Service</H2>
                        <p>
                    ...
                    <div>
                        <H2 className="mb-2">2. Use of the Website</H2>
                        <p>
                    ...
                    <div>
                        <H2 className="mb-2">3. Disclaimers ("As-Is")</H2>
                        <p>
                    ...
                    <div>
                        <H2 className="mb-2">5. Governing Law</H2>
                        <p>These terms are governed by the laws of New Zealand.</p>
                    </div>

                    <div className="pt-6 border-t border-border-subtle italic text-sm">
