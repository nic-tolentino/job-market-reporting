    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10 py-8 md:py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
                <Card className="flex flex-col items-center justify-center p-8 text-center space-y-4 hover:border-blue-200 transition-all">
                ...
                <Card className="flex flex-col items-center justify-center p-8 text-center space-y-4 hover:border-emerald-200 transition-all">
                    <div className="h-12 w-12 rounded-full bg-emerald-50 flex items-center justify-center text-emerald-600">
                        <MapPin className="h-6 w-6" />
                    </div>
                    <h3 className="font-bold text-slate-900 text-xl">Location</h3>
                    <p className="text-gray-500">Based in the beautiful city of sails.</p>
            ...
            <Card className="mx-4 p-8 bg-slate-900 text-white border-0 shadow-xl overflow-hidden relative">
