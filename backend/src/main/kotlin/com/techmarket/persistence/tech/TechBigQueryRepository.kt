...
class TechBigQueryRepository(
    ...
    private val log = LoggerFactory.getLogger(TechBigQueryRepository::class.java)
    ...
    override fun getTechDetails(techName: String, country: String?): TechDetailsPageDto {
        ...
        if (bigQuery == null) {
            log.warn("BigQuery unavailable - returning empty tech details for $techName")
            return TechMapper.mapTechDetails(techName, emptyList(), emptyList(), emptyList())
        }
