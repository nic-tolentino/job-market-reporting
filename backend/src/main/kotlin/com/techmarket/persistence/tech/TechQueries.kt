...
object TechQueries {
    ...
    data class TechQuery(
        val sql: String,
        val requiredFields: List<String>
    )

    fun getSenioritySql(datasetName: String, jobsTableName: String) = TechQuery(
        sql = """
            ...
            ORDER BY value DESC
        """.trimIndent(),
        requiredFields = listOf("name", "value")
    )

    fun getCompaniesSql(datasetName: String, jobsTableName: String, companiesTableName: String) = TechQuery(
        sql = """
        ...
        """.trimIndent(),
        requiredFields = listOf("id", "name", "logo", "activeRoles")
    )
