...
object CrawlRunFields {
    ...
    const val DETAIL_PAGES_ATTEMPTED = "detail_pages_attempted"
    const val DETAIL_PAGES_ENRICHED = "detail_pages_enriched"
    const val DESCRIPTION_COVERAGE = "description_coverage"
